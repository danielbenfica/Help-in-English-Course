...
import { PiListNumbers, PiTextAa, PiMathOperations, PiClockCountdown, PiPaletteBold} from "react-icons/pi";
...
export default function Settings(){
  ...
  function saveDatasUpdate(){
    ...
    {"durationAlphabet": ${durationAlphabet},"durationNumber":${durationNumber},"durationOperations":${durationOperations},"durationHours":${durationHours},"initialNumber":${initialNumber},"finalNumber":${finalNumber},"durationColors":${durationColors}}`)
  ...
  useEffect(() => {
    ...
    if(!localStorageDatas){
      localDatas = '{"durationAlphabet": 3,"durationNumber":3,"durationOperations":5,"durationHours":4,"initialNumber":0,"finalNumber":100,"durationColors":3}'
